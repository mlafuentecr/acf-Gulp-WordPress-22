...
$title_our_journey = $pageFields['slider_our_journey_small_title'];
...
if ($slider) {
 ...
 foreach ($slider as $index => $journey_slider) {
  ...
  echo '  <h3 class="title_small mt-md-5 mt-md-0" >' . $title_our_journey . '</h3>';
...
?>
  ...
  <section class="embody py-md-5" style="background-color: <?php echo $pageFields['embody_color']; ?>;">
    <div class="container py-md-5">
      <h3 class='title_small text-white py-5 my-md-0  '>
        <?php echo $pageFields['embody_title']; ?></h3>
...
if ($rows) {
 foreach ($rows as $item => $row) {
  ...
  echo "<div class='col my-5 px-md-5 text-white'><span class='number'> " . $item . " </span>";
