...
<?php if ($query->have_posts() && $query_next->have_posts()): ?>
                    ...
                    <?php if ($query->have_posts()): $p_index=0;?>
                        <?php while ($query->have_posts()): ?>
                            ...
                            <?php $post_fields = get_fields(); $id = get_the_ID(); ?>
                                ...
                                <div 
                                id="chapter-<?php echo $id; ?>"
                                class="p-university-post-sec-4__card-container 
                                <?php if ($p_index == 0) {
    echo  'p-university-post-sec-4__card-container_active';
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/inc/images/shape-hexagon-o-b.svg" alt="Shape" class="p-university-post-sec-4__cards-shape">
                </div>
            </div>
    ...
    echo '0';
                                ...
                                <div class="p-university-post-sec-4__accordion-content">
                                    <div 
                                    class="p-university-post-sec-4__card-container p-university-section-4__card-container">
                                        <div class="p-university-section-4__card">
                                            <div class="p-university-section-4__card-icon">
                                                <figure class="p-university-section-4__card-figure">
                                                    <img src="<?php echo $post_fields['icon']['url']; ?>" alt="Icon">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/inc/images/university/jump-sect-left-shapes.svg" alt="Shape" class="p-university-post-sec-4__shape p-university-post-sec-4__shape_left">

        <img src="<?php echo get_template_directory_uri(); ?>/inc/images/university/jump-sect-right-shape.svg" alt="Shape" class="p-university-post-sec-4__shape p-university-post-sec-4__shape_right">
    </section>
    <?php endif; ?>
  ...
  <section class="cta" >
    <div class="container">
      <div class="row">
        ...
        <a class=" <?php echo $btn?>" rel="noopener" href="<?php echo $link_url; ?>"
