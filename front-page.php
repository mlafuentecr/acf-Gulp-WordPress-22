...
<section class="competitors">
  <div class="container">
    ...
    <div class="title title-purple"><?php echo $second_heading; ?></div>
    <p><?php echo $second_text; ?></p>
    <div class="contentWrap">
      <div class="imgWrap">
        <?php if (!empty($second_image)) : ?>
        <img loading=“lazy” height="270px" width="500px" src="<?php echo esc_url($second_image['url']); ?>"
          alt="<?php echo esc_attr($second_image['alt']); ?>" />
        <?php endif; ?>
      </div>
      <div class="content ul-checkmark">
...
<section class="journey">
  <div class="container">
    ...
    <div class="title title-purple"><?php echo $third_heading; ?></div>
      ...
      <div class="tabsContent">
        ...
        if ($third_1imgs) {
          ...
          foreach ($third_1imgs as $img) {
            echo '<li ><img loading=“lazy” width="93px" height="93px" src="' . $img['img']["url"] . '" alt="' . $img['img']["name"] . '"></li>';
          }
          echo '</ul>';
        }
...
<section class="solution">
  <div class="container horizontal__block horizontal__block-lines">

    <div class="title title-purple mb-5"><?php echo $four_heading; ?></div>
...
<!-- 5 features -->
<section class="features horizontal__block full-bar bg-purple ">
  <div class="container">

    <div class="title "><?php echo $five_heading; ?></div>
    <div class="text mb-5"><?php echo $fifth_text; ?></div>
    ...
    <div class="contentWrap">
      ...
      if ($five_content) {
        foreach ($five_content as $key => $val) {
          $key = $key + 1;
          echo '<item class="item-' . $key . '">
          <div class="hexagon"> </div>
          <span class="sub-title">' . $val["title"] . '</span>
          <span class="sub-text">' . $val["text"] . '</span>
...
<section class="futureProof bg-lines">
  <div class="container">
    ...
    <div class="col col-4 ">
      <div class="wrap">
        <div class="title title-purple"><?php echo $sixth_heading; ?></div>
        <?php echo $sixth_col1; ?>
      </div>
    </div>
