...
<footer class="d-flex pt-4 footer_landing" style="background-image: url(<?php echo $bg_img['url']; ?>);">
  ...
  <div class="container ">
    <div class="row text-center">
      ...
      <div id="social-menu" class="col-12 col-md-12 col-lg-8 mb-5 mb-md-0  m-0 d-flex  flex-wrap text-white ">
        <!-- //Callus -->
        <div class="col-12 col-md-4 mb-3 mb-md-0 call  d-flex justify-content-center align-items-center "> CALL
          US <a
        ...
        <div class="social-wrap col-12 col-md-7 ms-4 widget-area  " role="social icons">
