    ...
    <div class="home-hero__content">
      ...
      <div id="home-hero-desk-slides-content" class="home-hero__slide-container">
        <div class="home-hero__slide slide_active">
          <h1 class="home-hero__title"><?php the_field('hero_heading'); ?></h1>
          <p class="home-hero__text home-hero__text_ma-w-570"><?php the_field('hero_text'); ?>
        </div>
        <?php 
        $slides = get_field('hero_slides',5);
        foreach ($slides as $slide) : ?>
        <div class="home-hero__slide">
          <h1 class="home-hero__title"><?php echo $slide['heading']; ?></h1>
