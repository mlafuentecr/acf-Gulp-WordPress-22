...
function enqueue_header()
{
  ...
  if ( is_front_page() ) {
   ...
   wp_enqueue_script('block_jobs',   $GLOBALS["THEME_MLM_PATH"].  '/dist/js/block_jobs.js?defer', array(), $GLOBALS['THEME_MLM_VER']);
    ...
    wp_enqueue_script('blogx',   $GLOBALS["THEME_MLM_PATH"] .    '/dist/js/blog.js?defer', array(), $GLOBALS['THEME_MLM_VER'], true);
  ...
  /*******************  bootstrap CSS  ********************/
  wp_enqueue_script('bootstrapjs', $GLOBALS["THEME_MLM_PATH"] .  '/dist/js/bootstrap.bundle.min.js', array(), $GLOBALS['THEME_MLM_VER'], true);
